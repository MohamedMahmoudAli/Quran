...
Uri quranAppUrl=Uri.parse("http://googl.com");
Future saveSetting()async{
  final sharedPref= await SharedPreferences.getInstance();
  await sharedPref.setInt("arabicFontSize", arabicFontSize.toInt());
  await sharedPref.setInt("mushafFontSize", mushafFontSize.toInt());
}
Future getSettings()async{
  try{
    final sharedPref= await SharedPreferences.getInstance();
    arabicFontSize=await sharedPref.getInt("arabicFontSize")!.toDouble();
    arabicFontSize=await sharedPref.getInt("mushafFontSize")!.toDouble();
